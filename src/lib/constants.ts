...
export const STYLE_TONES: Record<StyleId, string> = {
  ...
  french: "linear-gradient(160deg,#efe6d6,#cdb79a)",
  americanvintage: "linear-gradient(160deg,#b98e63,#6f4a30)",
  wabisabi: "linear-gradient(160deg,#cfc7b4,#a89d83)",
  modern: "linear-gradient(160deg,#d7d6cf,#a9aaa1)",
  quietluxury: "linear-gradient(160deg,#d8d0c4,#a89f90)",
