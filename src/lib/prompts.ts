...
export const STYLE_PROMPTS: Record<StyleId, string> = {
  ...
  french:
    "French Parisian (法式): an elegant tufted or curved-back sofa in soft ivory or dove linen, a pair of cane-back or cabriole-leg accent chairs, a marble-top coffee table with fluted brass-trimmed legs, an antique gilt-framed mirror, a crystal or aged-brass chandelier, gallery-hung framed art, a carved console with fresh flowers in a ceramic urn, layered sheer linen drapery and a faded antique medallion rug. Palette of warm ivory, soft greige, pale blush and antique gold with a deep navy or emerald accent. Soft diffused daylight with a warm golden glow, candlelit lamp fill at night. Romantic, refined, effortlessly elegant.",
  americanvintage:
    "American Vintage (美式复古): a deep walnut or cognac-leather Chesterfield or roll-arm sofa, a pair of vintage leather club chairs, a solid walnut coffee table, a brass-and-glass display cabinet, an aged-brass floor lamp and a green-glass banker's lamp, framed vintage art, stacked hardback books, a worn Persian or distressed vintage rug and heavy linen drapery. Palette of warm walnut, cognac, oxblood, forest green, caramel and cream with brass accents. Warm cinematic lighting, moody pools of amber lamplight against soft daylight. Nostalgic, characterful, film-like, cosy and lived-in.",
  quietluxury:
    "Quiet Luxury (静奢风): a large low-slung deep-seat sofa in greige or oatmeal boucle or a curved modular sectional, a sculptural travertine or marble coffee table, a Barcelona-style leather-and-steel lounge chair, a full-grain camel leather armchair, brushed champagne-metal and smoked-glass side tables, a thick tonal wool rug, floor-length sheer curtains and a few oversized matte ceramic vases. Palette of greige, taupe, sand, warm stone and ivory with charcoal and dark-walnut accents and subtle champagne-gold metal. Soft layered lamp and cove lighting, warm and even with no harsh contrast. Restrained, monochrome, expensively understated, old-money calm.",
  midcentury:
...
export const ARCHITECTURE_LOCK =
  "IMPORTANT: This is a real photo of an existing room. Preserve its architecture exactly: keep the same windows (same number of panels, same positions, size, proportions and any recessed bay or reveal), the same walls and wall color, the same doors, ceiling, skirting, floor, built-in shelving and alcoves, and the same camera viewpoint. Do not move, resize, re-frame, merge or flatten any window or door, do not change the room's shape, and do not add brick, concrete, paneling or wallpaper. Then fully and richly furnish this exact room in the style described, adding generous free-standing furniture, a rug, lighting, textiles, plants and wall art so it feels complete and beautifully styled.";
